    ...
    def on_data(self, data):
        try:
            try:
                ...
                #uncomment if you want to removing rows with polarity values of zero
                ...
                #dropping duplicated timestamps
                df_clean = df.drop_duplicates(subset=['Date'],keep='last')
                df2.to_csv('bitcoinSentimentClean.csv', mode='a') #later add if codition chceking if not empty then append mode='a'
